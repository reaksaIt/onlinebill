		...
		function readInvoice(){
			$.ajax({
				...
				success: function(data){
					...
					for(i in data){
						html+='<tr>';
						html+='<td class="w-2">'+ x++ +'</td>';
						html+='<td class="w-5">'+ data[i].iv_status+'</td>';
						html+='<td class"w-15>Invoice-'+ data[i].iv_num+'</td>';
						html+='<td class="w-10">'+ data[i].iv_date+'</td>';
						html+='<td class="w-10">'+ data[i].us_fname+' '+data[i].us_lname+'</td>';
						html+='<td class="w-15">'+ data[i].cus_name+'</td>';
						html+='<td class="w-8">$'+ parseFloat(data[i].quote_amount).toFixed(2)+'</td>';
						html+='<td class="w-8">$'+ parseFloat(data[i].iv_paid).toFixed(2)+'</td>';
						html+='<td class="w-8">$'+ parseFloat(data[i].iv_balance).toFixed(2)+'</td>';
						html+='<td class="w-10">'+data[i].iv_note+'</td>';
